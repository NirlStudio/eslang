...
modules.resolve = function (moduleUri, appDir, userHome, $void) {
  // try to split package name and module (file) path.
  var offset = moduleUri.indexOf('/')
  var pack = offset > 0 ? moduleUri.substring(0, offset) : moduleUri
  var mod = (offset > 0 && moduleUri.substring(offset + 1)) || pack
  ...
  var uri = path.join(dir, 'es', $void.appendExt(mod))
