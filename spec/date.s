...
(define "Value Conversion" (= ()
  ...
  (should "(date of-utc year month ...) returns a date by fields with utc values." (= ()
    ...
    (assert 1900 (((date of-utc 1900 1 2 3 4 5 6) date "utc") 0),
    (assert 1 (((date of-utc 1900 1 2 3 4 5 6) date "utc") 1),
    (assert 2 (((date of-utc 1900 1 2 3 4 5 6) date "utc") 2),
    (assert 3 (((date of-utc 1900 1 2 3 4 5 6) time "utc") 0),
    (assert 4 (((date of-utc 1900 1 2 3 4 5 6) time "utc") 1),
    (assert 5 (((date of-utc 1900 1 2 3 4 5 6) time "utc") 2),
    (assert 6 (((date of-utc 1900 1 2 3 4 5 6) time "utc") 3),
  ),
...
(define "Retrieve Date fields" (= ()
  (define "date fields" (= ()
    ...
    (should "(a-date date as-utc) returns year, month, day in month and day in week in UTC." (= ()
      (assert 2017 (((date of-utc 2017 6 29 1 1 1) date "utc") 0),
      (assert 6 (((date of-utc 2017 6 29 1 1 1) date "utc") 1),
      (assert 29 (((date of-utc 2017 6 29 1 1 1) date "utc") 2),
      (assert 4 (((date of-utc 2017 6 29 1 1 1) date "utc") 3),
    ),
  ),
  (define "time fields" (= ()
    ...
    (should "(a-date time as-utc) returns hours, minutes, seconds and milliseconds at the date in UTC." (= ()
      (assert 1 (((date of-utc 2017 6 29 1 2 3 4) time "utc") 0),
      (assert 2 (((date of-utc 2017 6 29 1 2 3 4) time "utc") 1),
      (assert 3 (((date of-utc 2017 6 29 1 2 3 4) time "utc") 2),
      (assert 4 (((date of-utc 2017 6 29 1 2 3 4) time "utc") 3),
    ),
  ),
  (define "date & time" (= ()
    ...
    (should "(a-date date-time as-utc) returns hours, minutes, seconds and milliseconds at the date in UTC." (= ()
      (let (d t) ((date of-utc 2017 6 29 1 2 3 4) date-time "utc"),
      (assert 2017 (d 0),
      (assert 6 (d 1),
      (assert 29 (d 2),
      (assert 4 (d 3),
