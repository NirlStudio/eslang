...
(define "Common Behaviours" (= ()
  ...
  (define "Ordering" (=> ()
    (should "a range is only comparable with equivalent ranges." (=> ()
      ...
      (assert -1 ((range of 1) compare (range of 2),
      (assert 1 ((range of 1 3) compare (range of 1 2),
      (assert -1 ((range of 1 2) compare (range of 1 3),
      (assert 1 ((range of 1 5) compare (range of 2 5),
      (assert -1 ((range of 2 5) compare (range of 1 5),
      (assert null ((range of 2 5) compare (range of 3 6),
      (assert null ((range of 3 6) compare (range of 2 5),
