...
(define "Searching Operations" (= ()
  (define "first" (= ()
    ...
    (should "(str first value) returns the offset of the first occurence of value or -1." (= ()
      (assert -1 ("" first "A"),
      (assert 0 ("ABC" first "A"),
      (assert 1 ("ABC" first "B"),
      (assert 2 ("ABC" first "C"),
      (assert -1 ("ABC" first "D"),
    ),
    (should "(str first value from) starts the searching from the value of 'from'." (= ()
      (assert -1 ("" first "A" 1),
      (assert -1 ("ABC" first "A" 1),
      (assert 1 ("ABC" first "B" 1),
      (assert 2 ("ABC" first "C" 1),
      (assert -1 ("ABC" first "D" 1),
    ),
  ),
  (define "last" (= ()
    ...
    (should "(str last value) returns the offset of the last occurence of value or -1." (= ()
      (assert -1 ("" last "A"),
      (assert 3 ("ABCABC" last "A"),
      (assert 4 ("ABCABC" last "B"),
      (assert 5 ("ABCABC" last "C"),
      (assert -1 ("ABCABC" last "D"),
    ),
    (should "(str last value from) starts the searching from the offset value of 'from'." (= ()
      (assert -1 ("" last "A" 1),
      (assert 0 ("ABCABC" last "A" -1),
      (assert 3 ("ABCABC" last "A" 3),
      (assert 1 ("ABCABC" last "B" 3),
      (assert 2 ("ABCABC" last "C" 3),
      (assert -1 ("ABCABC" last "D" 3),
    ),
  ),
  (define "starts-with" (= ()
